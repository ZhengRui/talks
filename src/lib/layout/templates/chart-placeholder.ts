import type { ChartPlaceholderSlideData } from "@/lib/types";
...
export function layoutChartPlaceholder(
  slide: ChartPlaceholderSlideData,
  theme: ResolvedTheme,
  imageBase: string,
): LayoutSlide {
  ...
  // Title + accent line (always present for chart-placeholder)
  ...
  // Chart image (centered, max ~55vh equivalent = ~594px)
